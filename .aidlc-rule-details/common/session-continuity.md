...
1. **Identify the track, then read its `state.md` first** when detecting existing work — consult the root Track Registry (`.aidlc-docs/registry.md`) to find the track, then read that track's `.aidlc-docs/tracks/<id>/state.md`
