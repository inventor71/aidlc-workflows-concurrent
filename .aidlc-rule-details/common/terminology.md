...
- Root `aidlc-state.md` (`.aidlc-docs/registry.md`): the **Track Registry** only (id/branch/worktree/status), edited just at track create/close.
- Root `audit.md` (`.aidlc-docs/log.md`): the **global timeline**, appended only at merge-time.
