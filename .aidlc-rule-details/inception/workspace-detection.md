...
Consult the root Track Registry (`.aidlc-docs/registry.md`) and `.aidlc-docs/tracks/`:
...
`.aidlc-docs/registry.md` only gets a registry row for this track (id/branch/worktree/status) —
